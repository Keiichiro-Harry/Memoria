...
class ScreenTransition extends StatefulWidget {
  ...
  @override
  _ScreenTransition createState() => _screenTransition;
}

_ScreenTransition _screenTransition = _ScreenTransition();

class _ScreenTransition extends State<ScreenTransition> {
                      ...
                      return Slidable(
                        ...
                        endActionPane: ActionPane(
                          ...
                          children: [
                            SlidableAction(
                              ...
                              foregroundColor: Colors.yellow, // (4)
                        ...
                        child: Card(
                          child: ListTile(
                              ...
                              trailing:
                                  documents[index]['email'] == widget.user.email
                                      ? IconButton(
